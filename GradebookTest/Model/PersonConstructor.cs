...
namespace GradebookTest.Model
{
    public class PersonConstructor
    {
        ...
        public void ShouldNotCreatePersonWhenMissingAnyParameters()
        {
            ...
            var exception1 = Assert.Throws<ArgumentNullException>(() => new Person(null, "Peter", DateOfBirth, "123 Happy St.", "Happy City", "CA", "91000", "2131101111", "M", "123456789", 1));
            Assert.That(exception1.ParamName, Is.EqualTo("Last name cannot be null"));

            var exception2 = Assert.Throws<ArgumentNullException>(() => new Person("Pan", null, DateOfBirth, "123 Happy St.", "Happy City", "CA", "91000", "2131101111", "M", "123456789", 1));
            Assert.That(exception2.ParamName, Is.EqualTo("First name cannot be null"));

            var exception4 = Assert.Throws<ArgumentNullException>(() => new Person("Pan", "Peter", DateOfBirth, null, "Happy City", "CA", "91000", "2131101111", "M", "123456789", 1));
            Assert.That(exception4.ParamName, Is.EqualTo("Street address cannot be null"));

            var exception5 = Assert.Throws<ArgumentNullException>(() => new Person("Pan", "Peter", DateOfBirth, "123 Happy St.", null, "CA", "91000", "2131101111", "M", "123456789", 1));
            Assert.That(exception5.ParamName, Is.EqualTo("City cannot be null"));

            var exception6 = Assert.Throws<ArgumentNullException>(() => new Person("Pan", "Peter", DateOfBirth, "123 Happy St.", "Happy City", null, "91000", "2131101111", "M", "123456789", 1));
            Assert.That(exception6.ParamName, Is.EqualTo("State cannot be null"));

            var exception7 = Assert.Throws<ArgumentNullException>(() => new Person("Pan", "Peter", DateOfBirth, "123 Happy St.", "Happy City", "CA", null, "2131101111", "M", "123456789", 1));
            Assert.That(exception7.ParamName, Is.EqualTo("Zip cannot be null"));

            var exception8 = Assert.Throws<ArgumentNullException>(() => new Person("Pan", "Peter", DateOfBirth, "123 Happy St.", "Happy City", "CA", "91000", null, "M", "123456789", 1));
            Assert.That(exception8.ParamName, Is.EqualTo("Phone number cannot be null"));

            var exception9 = Assert.Throws<ArgumentNullException>(() => new Person("Pan", "Peter", DateOfBirth, "123 Happy St.", "Happy City", "CA", "91000", "2131101111", null, "123456789", 1));
            Assert.That(exception9.ParamName, Is.EqualTo("Gender cannot be null"));

            var exception10 = Assert.Throws<ArgumentNullException>(() => new Person("Pan", "Peter", DateOfBirth, "123 Happy St.", "Happy City", "CA", "91000", "2131101111", "M", null, 1));
